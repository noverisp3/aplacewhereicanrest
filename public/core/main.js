...
function applyTheme(){var t=localStorage.getItem('theme')||'light';document.body.className=t;setTimeout(function(){document.body.classList.add('theme-ready')},100);var b=document.getElementById('theme-toggle');if(b)b.textContent=t.charAt(0);document.querySelectorAll('.theme-option').forEach(function(o){o.classList.toggle('active',o.dataset.theme===t)})}
